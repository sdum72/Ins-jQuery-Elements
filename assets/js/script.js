...
// titleEl.textContent = "Hello friends"; add text to an element
titleEl.text('Hello friends'); // <h1>Hello </h1>
console.log(titleEl)

// titleEl.className = 'fancy';
titleEl.attr('class', 'fancy'); // <h1 class="fancy">Hello friends</h1>
titleEl.attr('id', 'well');



// titleEl.classList.add('p-5') - (`p-5` is for padding)
titleEl.addClass('p-5'); // <h1 class="fancy p-5">Hello</h1>
